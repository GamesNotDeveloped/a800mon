...
type cliEmulatorCmd struct {
	...
	Sysinfo  cliEmptyCmd          `cmd:"" help:"Get system info."`
...
var emulatorCapabilities = []emulatorCapability{
	{0x0001, "Code breakpoints/history enabled (MONITOR_BREAK)."},
	{0x0002, "User breakpoint table enabled (MONITOR_BREAKPOINTS)."},
	{0x0003, "Atari 400/800 emulation available in this build."},
	{0x0004, "Atari XL/XE emulation available in this build."},
	{0x0005, "Atari 5200 emulation available in this build."},
}
