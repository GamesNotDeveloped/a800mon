...
| Value | Name | Meaning |
| --- | --- | --- |
| `0` | `STATUS_MACHINE_ATARI_800` | Atari 400/800 machine family. |
| `1` | `STATUS_MACHINE_XL_XE` | Atari XL/XE machine family. |
...
This command is no longer implemented by Remote Monitor. Requests with command
id `40` now return status `UNKNOWN_COMMAND`.
